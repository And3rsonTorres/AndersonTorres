...
const Footer = () => {
  return (
    <motion.footer
      ...
      className="bg-gradient-to-r from-sky-600  to-indigo-600 via-blue-600 md:text-3xl font-medium text-white text-center py-2 fixed bottom-0 left-0 w-full z-50"
    >
